...
#if defined(ROSCO_M68K) || defined(__MINT__)     // setup for rosco_m68k using Xosera board
...
#define XM_BASE_PTR 0x600        // contains Xosera base address (aka VDB_XOSERABASE, set by firmware)
